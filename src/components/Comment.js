...
export default function Comment ({
    ...
    //Определяет значение true или false и затем соответствующим образом отобразить HTML
    useEffect(() => {
        ...
        { 
            <div className='comment'>
                <div className='scoreColumn'>
                    {
                        //отключить функцию голосования за собственные комментарии пользователя
                        current 
                        ?
                        <>
